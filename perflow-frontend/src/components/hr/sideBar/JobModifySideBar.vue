...
<template>
  <Alert :model-value=successModalVisible message="직책 수정 성공!" @update:visible="updateSuccessModalVisible"/>
  <Alert :model-value=failModalVisible message="직책 수정 중 오류가 발생했습니다." @update:visible="updateFailModalVisible"/>
