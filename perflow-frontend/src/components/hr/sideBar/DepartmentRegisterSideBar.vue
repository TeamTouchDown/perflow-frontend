...
<template>
  <Alert :model-value=successModalVisible message="부서 등록에 성공했습니다!" @update:visible="updateSuccessModalVisible"/>
  <Alert :model-value=failModalVisible message="부서 등록 중 오류가 발생했습니다." @update:visible="updateFailModalVisible"/>
