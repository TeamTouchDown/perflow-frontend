...
<template>
  <Alert :visible=successModalVisible message="등록에 성공했습니다." @update:visible="updateSuccessModalVisible"/>
  <Alert :visible=failModalVisible message="사원 일괄 등록 중 오류가 발생했습니다." @update:visible="updateFailModalVisible"/>
