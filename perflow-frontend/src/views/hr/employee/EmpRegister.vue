...
<template>
  <Alert :model-value=successModalVisible message="사원 등록 성공!" @update:visible="updateSuccessModalVisible"/>
  <Alert :model-value=failModalVisible message="사원 등록 중 오류가 발생했습니다." @update:visible="updateFailModalVisible"/>
