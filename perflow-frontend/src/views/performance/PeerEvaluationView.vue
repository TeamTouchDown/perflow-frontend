<template>
        ...
        <div class="review-content">
          <div class="user-info">
            <div class="user-details">
              <p class="username">{{ peer.name }} {{ peer.position}}</p>
  ...
  <div v-if="isCreateModalOpen" class="modal-overlay">
    <div class="modal-content">
      <h2 class="modal-title">동료 평가 작성</h2>
...
async function fetchQuestionData() {
  ...
  try {
    const body1 = { deptId: MyInfo.value.deptId, questionType: "MULTIPLE", perfoType: "COL" };
    ...
    const body2 = { deptId: MyInfo.value.deptId, questionType: "SUBJECTIVE", perfoType: "COL" };
